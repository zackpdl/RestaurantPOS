...
class UtilityParser {
    ...
    parseUtility() {
        ...
        if (this.consumePeeked(`text-`)) {
            style = (0, font_size_1.default)(this.rest, theme, this.context);
            if (style)
                return style;
        ...
        if (this.consumePeeked(`size-`)) {
            style = (0, width_height_1.size)(this.rest, this.context, theme);
            if (style)
                return style;
        }
    ...
    parsePrefixes(prefixes, device, platform) {
        var _a, _b, _c, _d, _e;
        const widthBreakpoints = (0, screens_1.default)((_a = this.config.theme) === null || _a === void 0 ? void 0 : _a.screens);
